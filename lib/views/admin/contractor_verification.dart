...
class ContractorVerification extends StatefulWidget {
  @override
  _ContractorVerificationState createState() => _ContractorVerificationState();
}

class _ContractorVerificationState extends State<ContractorVerification> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: _repository.getContractor(_authPreference),
      builder:
          (BuildContext context, AsyncSnapshot<List<DataContractor>> snapshot) {
        if (snapshot.hasError) {
          return Center(child: Text("Load data gagal"));
        } else if (snapshot.connectionState == ConnectionState.done) {
          List<DataContractor> profesionals = snapshot.data;
  ...
  Widget _buildContent(List<DataContractor> profesionals) {
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            DataContractor profesional = profesionals[index];
            return Padding(
