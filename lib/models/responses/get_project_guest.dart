...
class GetProjectGuestResponse {
  bool success;
  List<ProjectGuest> data;
  String message;

  GetProjectGuestResponse({this.success, this.data, this.message});

  GetProjectGuestResponse.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = new List<ProjectGuest>();
      json['data'].forEach((v) {
        data.add(new ProjectGuest.fromJson(v));
      });
    }
...
class ProjectGuest {
  ...
  ProjectGuest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
