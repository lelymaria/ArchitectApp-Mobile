...
class ProfesionalSignUp extends StatefulWidget {
  @override
  _ProfesionalSignUpState createState() => _ProfesionalSignUpState();
}

class _ProfesionalSignUpState extends State<ProfesionalSignUp> {
  ...
  _onRegisterConsultant() async {
    if (formKey.currentState.validate()) {
      FocusScope.of(context).unfocus();
      print('files : $_file');
      loginBloc.add(
        RegisterConsultanPost(
